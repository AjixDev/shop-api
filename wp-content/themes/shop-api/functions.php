...
function enqueue_quasar_assets() {
	...
	wp_enqueue_script('cdn-script', 'https://cdn.jsdelivr.net/npm/vue@3/dist/vue.global.prod.js', true);
	wp_enqueue_script('cdn-script', 'https://cdn.jsdelivr.net/npm/quasar@2.12.4/dist/quasar.umd.prod.js', true);
}
